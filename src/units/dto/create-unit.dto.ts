...
export class CreateUnitDto {
  ...
  @ApiPropertyOptional({ description: 'Render image for interactive display of this unit' })
  @IsOptional()
  @IsString()
  renderImage?: string;

  @ApiPropertyOptional({ type: [PolygonPointDto], description: 'Polygon coordinates on the floor renderImage (percentage-based)' })
  @IsOptional()
  @IsArray()
  @ValidateNested({ each: true })
